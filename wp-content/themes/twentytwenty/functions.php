...
function create_custom_taxonomy() {
  ...
  register_taxonomy('countries',array('properties'), array(
    'hierarchical' => true,
...
function create_custom_post_type() {
    ...
    $labels = array(
        'name'                => _x( 'Properties', 'Post Type General Name', 'twentytwenty' ),
        'singular_name'       => _x( 'Property', 'Post Type Singular Name', 'twentytwenty' ),
        'menu_name'           => __( 'Properties', 'twentytwenty' ),
        'parent_item_colon'   => __( 'Parent Property', 'twentytwenty' ),
        'all_items'           => __( 'All Properties', 'twentytwenty' ),
        'view_item'           => __( 'View Property', 'twentytwenty' ),
        'add_new_item'        => __( 'Add New Property', 'twentytwenty' ),
        'add_new'             => __( 'Add New', 'twentytwenty' ),
        'edit_item'           => __( 'Edit Property', 'twentytwenty' ),
        'update_item'         => __( 'Update Property', 'twentytwenty' ),
        'search_items'        => __( 'Search Property', 'twentytwenty' ),
    ...
    $args = array(
        'label'               => __( 'properties', 'twentytwenty' ),
        'description'         => __( 'Property news and reviews', 'twentytwenty' ),
        'labels'              => $labels,
...
function load_Custom_scripts(){
	...
	wp_enqueue_style( 'dev', get_template_directory_uri() . '/assets/css/dev.css',false,'1.1','all');
	wp_enqueue_script( 'my-jquery', get_template_directory_uri() . '/assets/js/jquery-3.5.1.min.js', false, '3.5.1' );
}
...
<?php 
	$search_country = $_REQUEST["country"];
	$search_city = $_REQUEST["city"];
	$args = array(
...
add_action( 'wp_ajax_nopriv_get_search_results_cities', 'get_search_results_cities' );
add_action( 'wp_ajax_get_search_results_cities', 'get_search_results_cities' );
function get_search_results_cities(){
	$search_country = $_REQUEST["country"];
